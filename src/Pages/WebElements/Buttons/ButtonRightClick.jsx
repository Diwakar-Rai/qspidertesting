...
const ButtonRightClick = () => {
  ...
  return (
    <div className="form_content absolute left-[248px]  rounded-[20px] top-[70px] ml-[20px] h-[640px] w-[1020px] flex flex-col">
      <div className="bg-white rounded-md h-[100%] w-[100%] border border-orange-200 shadow-sm shadow-orange-300 p-5 overflow-y-scroll scrollbar scrollbar-w-2 scrollbar-thumb-[#a8a8a8] scrollbar-track-transparent scrollbar-thumb-rounded-md">
        {click ? (
        ...
        {verify ? (
          <section className="flex justify-center absolute w-[100%] top-[-20px]">
            <span className="bg-gradient-to-r from-orange-400 to-orange-600 text-white rounded-full text-center relative py-1 font-bold text-[20px] w-[50%]">
              How to verify, A button is clicked?
            </span>
          </section>
        ) : null}
            ...
            <section className="bg-white rounded-xl">
              ...
              <section className="ps-10 px-4">
                <article className="relative pb-4">
                  ...
                  <button
                    className={`relative active:bg-green-400 transition-all duration-300 active:border-green-400 rounded-md mx-1 px-5 py-2 text-black font-bold   ${
                      signUp1
                  ...
                  {sign && (
                    <div className="origin-top-right absolute left-0 mt-2 w-32 z-20 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                      <div
                        className="py-1 ps-1 hover:bg-orange-300"
                        onClick={() => {
                          setSign(false);
                          setSignUp1(true);
                          setSignUp2(false);
                      ...
                      <div
                        className="py-1 hover:bg-orange-300"
                        onClick={() => {
                          setSign(false);
                          setSignUp1(false);
                          setSignUp2(false);
